...
.pre:
	@echo "--------------------------------------"
	@echo "User defined pre-build step: [python D:\ECE118Directory\scripts\Enum_To_String.py]"
	@python D:\ECE118Directory\scripts\Enum_To_String.py
	@echo "--------------------------------------"
