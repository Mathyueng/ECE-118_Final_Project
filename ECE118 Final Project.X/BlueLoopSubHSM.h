...
#ifndef SUB_BLUELOOP_HSM_H  // <- This should be changed to your own guard on both
#define SUB_BLUELOOP_HSM_H  //    of these lines
...
/**
 * @Function InitBlueloopSubHSM(void)
