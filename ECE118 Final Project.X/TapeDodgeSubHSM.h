...
#ifndef TAPE_DODGE_SUB_HSM_H  // <- This should be changed to your own guard on both
#define TAPE_DODGE_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitTapeDodgeSubHSM(void)
